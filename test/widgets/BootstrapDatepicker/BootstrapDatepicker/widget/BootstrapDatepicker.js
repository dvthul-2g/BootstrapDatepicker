...
*/
mxui.dom.addCss(dojo.moduleUrl("BootstrapDatepicker", "css/datepicker.css"));
mxui.dom.addCss(dojo.moduleUrl("BootstrapDatepicker", "css/datepicker3.css"));
...
require({
    ...
    return declare('BootstrapDatepicker.widget.BootstrapDatepicker', [ _WidgetBase, _TemplatedMixin ], {
        ...
        _updateRendering: function () {
            ...
            //console.log(this.id + '.updateRendering', obj.get(this.dateattr), new Date(obj.get(this.dateattr)));obj;
			var date1 = obj.get(this.dateattr);
			var enabled = obj.isReadonlyAttr(this.dateattr);
			if (enabled) {
				this.enable();
			} else {
				this.disable();
        ...
        enable: function () {
			console.log('enabled', this.readonly);
			if (!this.readonly) {
				this.enabled = true;
